...
import numpy as np
import pandas as pd #pip install pandas to installs pandas in your pc

#Read data from the file called 'credit.csv' into a DataFrame
article_read = pd.read_csv('credit.csv', delim_whitespace = 1)#specify tha the delimiter is a single space
